       ...
       /* function R() {
        ...
        function S() {
            ...
            if (!c.autoScrolling && !f.hasClass("active")) {
                F = !0;
                var ra = b(".fp-section.active").index(".fp-section") + 1, g = G(f), h = f.data("anchor"),
                    k = f.index(".fp-section") + 1, l = f.find(".fp-slide.active");
        ...
        function z(a, d) {
            if (l[a]) {
                if ("down" ==
                    a)var c = "bottom",
                    f = b.fn.ronbongpage.moveSectionDown; else c = "top", f = b.fn.ronbongpage.moveSectionUp;
        ...
        function sa(a) {
            ...
            if (!W(a.target)) {
                ...
                m || t || (d = X(d), u = d.y, A = d.x, a.find(".fp-slides").length && Math.abs(B - A) > Math.abs(v - u) ? Math.abs(B - A) > b(window).width() / 100 * c.touchSensitivity &&
                    (B > A ? l.right && b.fn.ronbongpage.moveSlideRight() : l.left && b.fn.ronbongpage.moveSlideLeft()) : c.autoScrolling && !c.scrollBar && Math.abs(v - u) > b(window).height() / 100 * c.touchSensitivity && (v > u ? z("down", e) : u > v && z("up", e)))
            }
        }
        ...
        function Y(a) {
            ...
            if (d.length && !t) {
                var e = d.find(".fp-slide.active"), f = null,
        ...
        function w(a, d) {
            var e = d.position(), f = a.find(".fp-slidesContainer").parent(), g = d.index(),
                h = a.closest(".fp-section"), k = h.index(".fp-section"), l = h.data("anchor"),
                n = h.find(".fp-slidesNav"), m = d.data("anchor"), q = x;
            if (c.onSlideLeave) {
                var p =
        ...
        function ga() {
            ...
            if (C) {
                if ("text" !== b(document.activeElement).attr("type")) {
                    ...
                    Math.abs(a - M) > 20 * Math.max(M, a) / 100 && (b.fn.ronbongpage.reBuild(!0),
                        M = a)
                }
        ...
        (function () {
            c.continuousVertical && (c.loopTop || c.loopBottom) && (c.continuousVertical =
                !1, E("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
        ...
        b.fn.ronbongpage.setAllowScrolling = function (a, c) {
            if ("undefined" != typeof c) c = c.replace(" ", "").split(","), b.each(c, function (c, d) {
                ...
                if (b.fn.ronbongpage.setMouseWheelScrolling(!0), C || P) MSPointer = oa(), b(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ta), b(document).off("touchmove " +
                    MSPointer.move).on("touchmove " + MSPointer.move, sa)
            } else if (b.fn.ronbongpage.setMouseWheelScrolling(!1), C || P) MSPointer = oa(), b(document).off("touchstart " + MSPointer.down), b(document).off("touchmove " + MSPointer.move)
        };
        ...
        var t = !1,
            ...
            P = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, g = b(this),
            h = b(window).height(), m = !1, x = !1, p, K, k, ca = "ronbongpage-wrapper",
            l = {up: !0, down: !0, left: !0, right: !0}, N = jQuery.extend(!0, {}, c);
...
(function () {
    ...
    window.Rbslider = function (container, params) {
        ...
        s.updateSlidesSize = function () {
            ...
            for (i = 0; i < s.slides.length; i++) {
                ...
                if (s.params.slidesPerColumn > 1) {
                    ...
                    slide.css({'margin-top': (row !== 0 && s.params.spaceBetween) && (s.params.spaceBetween + 'px')}).attr('data-rbslider-column', column).attr('data-rbslider-row', row)
                }
        ...
        if (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) {
            (s.params.touchEventsTarget === 'container' ? s.container : s.wrapper).addClass('rbslider-wp8-' + s.params.direction)
        }
        ...
        var isTouched, isMoved, touchStartTime, isScrolling, currentTranslate, startTranslate, allowThresholdMove,
            formElements = 'input, select, textarea, button', lastClickTime = Date.now(), clickTimeout, velocities = [],
            allowMomentumBounce;
        s.animating = false;
        ...
        s.onTouchMove = function (e) {
            ...
            if (s.params.freeMode) {
                if (velocities.length === 0) {
                    velocities.push({position: s.touches[isH() ? 'startX' : 'startY'], time: touchStartTime})
                }
        ...
        s.lazy = {
            initialImageLoaded: false, loadImageInSlide: function (index) {
...
var caseListHtml = $(".case-list").html(), equipmentListHtml = $(".equipment-list").html(), rbslider2 = null,
    rbsliderInterval = 0, rbslider3 = null, rbsliderInterval2 = 0;
...
function initPartnerImg() {
    ...
    $(".partner-list li").each(function () {
        var a = $(this).find("img"), c = a.height();
...
$(function () {
    ...
    (function () {
        function a() {
            var a = 20 * d;
            $(".home-news ul").css({marginTop: -a});
            d++;
            d = d >= b ? 0 : d
        }

        var c = 0, d = 0, b = $(".home-news ul li").size();
    ...
    (function () {
        function a() {
            ...
            var a = $(".home-about-navi li").eq(d), c = $(".home-about-navi").offset();
            700 < $(window).width() ? (a = a.offset().top - c.top, $(".home-about-navi li.bg").css({
                top: a,
                left: 0
            })) : (a = a.offset().left - c.left, $(".home-about-navi li.bg").css({left: a, top: 0}));
            d++;
            d = d >= b ? 0 : d
        }

        var c = 0, d = 0, b = $(".home-about li").size();
        ...
        $(".home-about-navi li").mouseenter(function () {
            if (700 < $(window).width()) {
                var b =
                    $(this).offset().top - $(".home-about-navi").offset().top;
                $(".home-about-navi li.bg").css({top: b, left: 0})
            } else b = $(this).offset().left - $(".home-about-navi").offset().left, $(".home-about-navi li.bg").css({
                left: b,
                top: 0
            });
            clearInterval(c);
    ...
    new Rbslider(".rbslider-container", {
        pagination: ".page1 .rbslider-pagination", paginationClickable: !0, spaceBetween: 0, speed: 1300,
        autoplay: 5E3, slideToClickedSlide: !0, autoplayDisableOnInteraction: !0
    });
